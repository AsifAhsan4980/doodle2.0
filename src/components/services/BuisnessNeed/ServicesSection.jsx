	...
	return (
		<section className="px-5 py-28 w-full bg-white max-md:py-24">
			<div className="container mx-auto">
				...
				<div className="absolute gap-6 right-20">
					...
					<div className="flex gap-2.5 items-start">
						...
						<ImageComponent
							...
							alt=""
							className="object-contain shrink-0 self-start ml-5 aspect-[0.34] w-[21px]"
						/>
						<ImageComponent
					...
					<ImageComponent
						src="https://cdn.builder.io/api/v1/image/assets/TEMP/2a7b42180580378e58687c2a812071212fac1ad0c4a759494a34bc7874d08045?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c"
						alt="" className="object-contain shrink-0 self-end aspect-[3.47] mt-5 ml-20 pl-5"
					/>
				</div>

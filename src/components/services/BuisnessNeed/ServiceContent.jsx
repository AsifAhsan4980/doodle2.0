...
function ServiceContent() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-20 mb-0 w-full max-w-[1614px] max-md:mb-2.5 max-md:max-w-full">
            <div className="flex flex-col text-base leading-9 text-black max-md:max-w-full">
                ...
                <ImageComponent src="https://cdn.builder.io/api/v1/image/assets/TEMP/9ce16786d6862417bbb7bf951a26a380aa093c0841b6ef45c02e79a4ab96cf37?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c" alt="" className="object-contain self-end aspect-[2.05] w-fit" />
            </div>
            <div className="relative flex flex-col justify-center items-center px-20 py-32 mt-1.5 min-h-[385px] max-md:px-5 max-md:py-24 max-md:max-w-full">
                <ImageComponent src="https://cdn.builder.io/api/v1/image/assets/TEMP/11e5141083cffc86b6b82f80fe0528b18f4635238b46b8ca341d2d99f239ad19?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c" alt="Background image" className="object-cover absolute inset-0 w-full h-full  border-[3px] border-[#777] rounded-lg" />

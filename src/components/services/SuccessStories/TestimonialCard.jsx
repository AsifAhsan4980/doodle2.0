  ...
  return (
    <article className="flex flex-col max-md:ml-0 max-md:w-full">
      <div className={cardClasses}>
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/bd329374ffc7ab104928c8c74cfc5f679c8af897cb32d21dcc9fe52973c47af7?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c" alt="" className={`object-contain aspect-square w-[88px] `} />

...
function SuccessStories() {
  return (
      <section className="flex flex-col items-center px-2 py-28 w-full bg-white max-md:py-24 max-md:max-w-full">
        <div className=" container flex flex-col w-full  max-md:max-w-full">
            ...
            <div className="flex gap-5 max-md:flex-col">
              <div className="flex flex-col w-[31%] max-md:ml-0 max-md:w-full">
                <div className="flex gap-3 text-zinc-800 max-md:mt-10">
                  <img loading="lazy"
                       src="https://cdn.builder.io/api/v1/image/assets/TEMP/617e7342b02624508bf4139980eb8d6d30306ed5c72cde1b2d20dc2adf067327?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c"
                       alt="" className="object-contain shrink-0 self-start mt-3.5 aspect-[31.25] w-[31px]"/>
                  <div className="flex flex-col grow shrink-0 basis-0 w-fit relative">
                    ...
                    <div className="block">
                      <h1 className="mt-6 text-4xl font-bold tracking-normal leading-none flex items-center">
                        ...
                        <div
                            className="text-black relative w-2/5 " style={{
                          backgroundImage: `url("${MySvg.src}")`,
              ...
              <div className="flex flex-col ml-5 w-[69%] max-md:ml-0 max-md:w-full">
                <p className="mt-14 text-lg leading-10 text-black max-md:mt-10 max-md:max-w-full">
                  Lorem Ipsum. Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi
          ...
          <div
              className="flex gap-4 self-start mt-14 text-lg font-medium leading-none whitespace-nowrap text-zinc-800 max-md:mt-10">
            <img loading="lazy"
                 ...
                 alt="" className="object-contain shrink-0 my-auto aspect-[31.25] w-[31px]"/>
            ...
            <div className="flex gap-5 max-md:flex-col">
              ...
              <div className="flex flex-col ml-5 w-[67%] max-md:ml-0 max-md:w-full">
                <p className="mt-2.5 text-lg leading-10 text-black max-md:mt-10 max-md:max-w-full">
                  ...
                  opportunities for growth. Explore our comprehensive range of services designed to meet your unique
                  needs and drive success. Let us help you optimize your operations and achieve your business goals.
                </p>
              </div>
            </div>
          </div>
          ...
          {/*<img loading="lazy"*/}
          {/*     src="https://cdn.builder.io/api/v1/image/assets/TEMP/bd6f87e6ff8b4a47f52fa8b8dde2d1024d3b52da77f408473ad8d5e444737c7a?placeholderIfAbsent=true&apiKey=8390c896bcb7435f9438ea31eaafd63c"*/}
          {/*     alt=""*/}
          {/*     className="object-contain mt-20 -mb-6 max-w-full aspect-[50] w-[150px] max-md:mt-10 max-md:mb-2.5"/>*/}
        </div>
